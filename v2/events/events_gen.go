...
const (
	...
	EventDistributorAuthorizationUpdated      EventName = "DistributorAuthorizationUpdated"
...
var allEvents = map[string]EventName{
	...
	string(EventDistributorAuthorizationUpdated):      EventDistributorAuthorizationUpdated,
...
// DistributorAuthorizationUpdated event.
...
type RedemptionRequested struct {
	...
	FundTokenId     common.Hash    `json:"fund_token_id"`
	DistributorAddr common.Address `json:"distributor_addr"`
	ReferenceID     common.Hash    `json:"reference_id"`
	RequestId       common.Hash    `json:"request_id"`
	Shares          *big.Int       `json:"shares"`
