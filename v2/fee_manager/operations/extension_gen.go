...
func (o *Options) validate() error {
	...
	if !common.IsHexAddress(o.FeeManagerAddress) {
		return fmt.Errorf("invalid FeeManagerAddress: %q", o.FeeManagerAddress)
	}
...
func New(opts *Options) (*Extension, error) {
	...
	return &Extension{
		...
		feeManagerAddress: common.HexToAddress(opts.FeeManagerAddress),
	}, nil
}
