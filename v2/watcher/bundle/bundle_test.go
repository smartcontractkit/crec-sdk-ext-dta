...
import (
	...
	"github.com/smartcontractkit/crec-sdk-ext-dta/v2/watcher/bundle"
)
...
func TestBundle_Get(t *testing.T) {
	...
	t.Run("Contracts", func(t *testing.T) {
		...
		assert.Equal(t, "DTARequestSettlement", b.Contracts[1].Name)
		assert.NotEmpty(t, b.Contracts[1].ABI)
	})
