...
// PrepareFeeManagerOperation prepares a generic operation on FeeManager.
// Use this for methods not covered by the type-safe Prepare* functions.
func (e *Extension) PrepareFeeManagerOperation(method string, args ...interface{}) (*transactTypes.Operation, error) {
	return e.prepareOperation(FeeManagerABI(), e.feeManagerAddress, method, args...)
}

func (e *Extension) prepareFeeManagerOp(method string, args ...interface{}) (*transactTypes.Operation, error) {
	return e.prepareOperation(FeeManagerABI(), e.feeManagerAddress, method, args...)
}
